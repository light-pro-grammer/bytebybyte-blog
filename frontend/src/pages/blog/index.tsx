...
export default function BlogPage({ data: { blogPosts, page, totalPages } }: BlogPageProps) {
  ...
  return (
    <>
      <Head>
        <title>Articles - ByteByByte Blog</title>
        <meta
          name="description"
          content="Explore a collection of in-depth web development articles, from foundational concepts to advanced techniques."
        />
      </Head>
